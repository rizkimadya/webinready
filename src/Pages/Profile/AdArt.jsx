		...
		<>
			<div className="grid md:px-20 px-4 py-24">
				<div className="container mx-auto">
					<div className="my-12">
						<p className="text-left text-5xl font-semibold mb-2">AD-ART</p>
						<div className="w-24 h-1 bg-black"></div>
					</div>
					<div className="md:my-28">
						<p className="text-left font-semibold text-3xl mb-6">
						...
						<p className="text-justify text-2xl tracking-tighter">
							...
							porta. Et sit platea lectus sit <br /> adipiscing posuere viverra
							velit. Et purus iaculis ac vitae viverra. Quisque semper ornare
							volutpat sed. Scelerisque donec quisque enim cras id nec felis
							quis. Lobortis velit augue consequat neque ultricies. In et
